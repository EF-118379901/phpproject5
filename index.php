...
<html>
    ...
    <body>
        ...
        <link rel="stylesheet"
              href="https://maxcdn.bootstrapcdn.com/bootsrap/4.0.0-beta.2/css/bootstrap.min.css"
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link rounded js-scroll-trigger" href="CV.html">CV</a>
            </li>
            <li class="nav-item">
                <a class="nav-link rounded js-scroll-trigger" href="Interests.html">Interests</a>
            
            </li>
            
             <li class="nav-item">
                 <a class="nav-link rounded js-scroll-trigger" href="Consulting Services home page.php">Strategic Consulting Services</a>
